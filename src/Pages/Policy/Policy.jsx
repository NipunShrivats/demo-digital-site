      ...
      <div className="container privacyPolicy">
        ...
        <div>
          ...
          <p>
            ...
            address and browser user agent string to help spam detection. An
            anonymized string created from your email address (also called a
        ...
        <div>
          ...
          <p>
            ...
            browser. When you log in, we will also set up several cookies to
            save your login information and your screen display choices. Login
            ...
            removed. If you edit or publish an article, an additional cookie
            will be saved in your browser. This cookie includes no personal data
            and simply indicates the post ID of the article you just edited. It
            expires after 1 day.
          </p>
        </div>
        <div>
          ...
          <p>
            ...
            the other website. These websites may collect data about you, use
